...
namespace MvcTeam.Utilities.Models
{
    public class CrmEmail : EntityObject
    {
        ...
        public string Name { get { return GetValue("subject"); } set { SetValue("subject", value); } }

        public bool ReadState { get { return Entity.GetAttributeValue<bool>("new_emailreadstatus"); } set { SetValue("new_emailreadstatus", value); } }
    }
