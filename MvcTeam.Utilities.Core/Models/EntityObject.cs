...
namespace MvcTeam.Utilities.Models
{
    public class EntityObject
    {
        ...
        {
            if (Entity.Attributes.ContainsKey(key) && Entity[key] != null)
            {
                ...
                if (type == typeof(decimal)) { return Entity[key].ToString(); }
                if (type == typeof(DateTime)) { return ((DateTime)Entity[key]).ToString("o"); }
