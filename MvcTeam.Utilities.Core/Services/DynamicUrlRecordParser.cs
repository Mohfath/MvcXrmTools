    ...
    public class DynamicUrlParser
        {
            ...
            public DynamicUrlParser(string url)
            {
                try
                {
                    ...
                    foreach (string param in parameters)
                    {
                        ...
                        //Uri keeps values encoded, and CRM often sends the id as %7b...%7d (braces)
                        var value = nameValue.Length > 1 ? Uri.UnescapeDataString(nameValue[1]) : "";
                        switch (nameValue[0])
                        {
                            case "etc":
            ...
            {
                //آدرس های رابط کاربری جدید نام موجودیت را مستقیم دارند
