...
public class DateTime_DateDiffBusinessMinutes : WorkFlowActivityBase
{
    public DateTime_DateDiffBusinessMinutes() : base(typeof(DateTime_DateDiffBusinessMinutes)) { }
