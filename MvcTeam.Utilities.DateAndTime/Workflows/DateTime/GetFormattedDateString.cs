...
public sealed class DateTime_GetFormattedDateString : WorkFlowActivityBase
{
    public DateTime_GetFormattedDateString() : base(typeof(DateTime_GetFormattedDateString)) { }
