...
public class Email_CcBusinessUnit : WorkFlowActivityBase
{
    public Email_CcBusinessUnit() : base(typeof(Email_CcBusinessUnit)) { }
    ...
    private static List<Entity> ProcessUsers(EntityCollection teamMembers, List<Entity> ccList)
    {
        foreach (Entity e in teamMembers.Entities)
        {
            ...
            if (EmailRecipients.Contains(ccList, e.Id)) continue;
