...
public class Email_DeleteEmailAttachmentByName : WorkFlowActivityBase
{
    public Email_DeleteEmailAttachmentByName() : base(typeof(Email_DeleteEmailAttachmentByName)) { }
